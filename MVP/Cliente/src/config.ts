...
const envWhatsapp = (import.meta.env.VITE_BARBEARIA_WHATSAPP as string | undefined) || '';

export const defaultPublicSettings: PublicSettings = {
  nome: 'Alcateia Barber',
  whatsapp: envWhatsapp,
  instagramUrl: (import.meta.env.VITE_INSTAGRAM_URL as string | undefined) || 'https://www.instagram.com/barbearia_alcateia_/',
  whatsappUrl: envWhatsapp ? `https://wa.me/${envWhatsapp.replace(/\D/g, '')}` : '',
